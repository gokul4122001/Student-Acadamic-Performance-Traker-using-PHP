    ...
    <div class="hero">
      <div class="form-box">
        <div class="button-box">
          <div id="btn" style="margin-left:50px;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<sub> Login</sub></div>
          <button type="button" class="toggle-btn" style="margin-left:50px;" onclick="login()">Submit</button>
