...
<div class="banner_image">
        <div class="form-box">
        	<div class="button-box">
                <div>
                <h2><center>Update Class Test</center></h2></div>
                </div>
	<form method="POST">
	...
	if (isset($_POST['submit'])) {
		...
		$sql = "SELECT * FROM `test` WHERE stud_id='$stud_id' AND sub_id='$sub_id' AND month='$month'";
		...
		if ($result->num_rows ==0) {
			...
			$sql = "INSERT INTO test (stud_id, sub_id, month, total, marks)VALUES ('$stud_id', '$sub_id', '$month', '$total', '$marks')";
