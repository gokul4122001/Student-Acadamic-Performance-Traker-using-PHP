	...
	<div class="navbar">
	    <div class="logo">
		    ...
		    <div class="navbar_items">
			  ...
			  <li><a href="teach_login.php">STUDENT</a></li>
...
<div class="banner_image">
	...
	if (isset($_POST['submit'])) {
		...
		$sql = "SELECT * FROM `result` WHERE stud_id='$stud_id' AND sub_id='$sub_id' AND month='$month'";
		...
		if ($result->num_rows ==0) {
			...
			$sql = "INSERT INTO result (stud_id, sub_id, month, total, marks)VALUES ('$stud_id', '$sub_id', '$month', '$total', '$marks')";
